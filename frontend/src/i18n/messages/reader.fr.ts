...
const reader: Area<'reader'> = {
  ...
  'selections.dock.combinedProbabilityWithheld': 'Aucune chance combinée n’est affichée\u00a0: la probabilité d’une sélection « remboursé si nul » est conditionnelle à l’absence de nul et ne peut pas être multipliée avec les autres. La probabilité propre de chaque sélection reste affichée.',
  'selections.dock.priceOriginal': 'Cote enregistrée {price}',
  'selections.dock.priceEffective': 'Cote effective {price} — une sélection annulée est sortie du coupon',
  'selections.dock.potentialWithheld': 'Retour ajusté non affiché\u00a0: {reason}',
