...
const TodayPredictionsPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Today's Soccer Predictions - {today}</title>
        <meta name="description" content={`Professional soccer predictions for ${today}. Get expert betting tips and match analysis for today's games.`} />
      </Helmet>
      ...
      <div className="min-h-screen bg-dark-950 py-8">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-secondary-400">{today}</p>
