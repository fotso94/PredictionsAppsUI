 ...
 * Retained as a fallback integration (Phase 1 uses the backend match API). Untested against the live service.
 * The key comes from VITE_THESPORTSDB_KEY; without it the free v1 test key '3' is used (limited data).
 * 
...
// API Configuration
const API_CONFIG = {
  apiKey: import.meta.env.VITE_THESPORTSDB_KEY || '3',
  baseURL: `https://www.thesportsdb.com/api/v1/json/${import.meta.env.VITE_THESPORTSDB_KEY || '3'}`,
  timeout: 10000,
};
